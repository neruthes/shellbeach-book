...
\usepackage[PunctStyle=plain,RubberPunctSkip=false,CJKglue=,CJKecglue=\hskip 5pt plus 20pt]{xeCJK}
...
\newcommand{\useimgsmall}[1]{
    \noindent\begin{minipage}{\linewidth}
        \centering
        \vspace{3pt}
        \includegraphics[width=14em,keepaspectratio,height=12em]{#1}
        \vspace{3pt}
    \end{minipage}
}
\newcommand{\midnote}[1]{
...
\newcommand{\quotefont}[0]{
    \rmfamily
    \fontspec[Ligatures=TeX]{NewComputerModern}
    \CJKfontspec[AutoFakeBold={2.60}]{FandolKai}
}
...
\begin{titlepage}
    ...
    \parindent=0pt
    % \sffamily
    \includegraphics[width=60mm]{shellbeach-avatar-2022.jpg}
    \vspace{20pt}
